...
# ================== PDF MODE ==================
    ...
    uploaded_pdf = st.file_uploader(
        "Upload a medical PDF (WHO, reports, guidelines)",
        type=["pdf"]
    )
    ...
    if uploaded_pdf and pdf_question.strip():
        ...
        with st.spinner("Reading uploaded medical document..."):
...
def render_chat(upto=None):
    ...
    # Auto-scroll to latest message (ChatGPT-like)
...
# ------------------ DISPLAY CHAT (ONLY IN CHAT MODE) ------------------
if mode == "💬 Chat":
